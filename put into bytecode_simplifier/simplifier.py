        ...
        while bb_merged:
            ...
            for bb in list(self.bb_graph.nodes()):
                ...
                if not bb.has_xrefs_to and self.bb_graph.in_degree(bb) == 1:
                    ...
                    if self.bb_graph.out_degree(predecessorBB) == 1 and list(self.bb_graph.successors(predecessorBB))[
                        0] == bb:
                        ...
                        if bb in nx.get_node_attributes(self.bb_graph, 'isTerminal').keys():
                            nx.set_node_attributes(self.bb_graph, name='isTerminal', values={mergedBB: True})
